      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full mx-4 p-6 relative">
        ...
        <div className="text-center">
          ...
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 overflow-hidden">
            <img 
              src="https://i.postimg.cc/KvXCcTcg/dhunathub.png" 
              alt="DhunatHub Logo" 
          ...
          {/* App Name */}
          <h2 className="text-xl font-semibold text-gray-900 mb-2">DhunatHub</h2>
          <p className="text-gray-600 text-sm mb-6">Install our app for a better experience</p>
